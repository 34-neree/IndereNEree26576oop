...
class Truck extends Vehicle {
    ...
    public Truck(String vehicleId, String ownerName, int yearOfFabrication, String registrationNumber,
                 double baseTaxRate, double loadCapacity) {
    ...
    public double calculateTax() {
        ...
        if (java.time.Year.now().getValue() - yearOfFabrication > 15) tax *= 1.15;
