...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            System.out.println("\n----- vehiclemanagementsystem.Vehicle Tax Management System -----");
    ...
    private static void registerVehicle() {
        System.out.println("\n--- Register a New vehiclemanagementsystem.Vehicle ---");
        ...
        if (vehicle != null) {
            ...
            System.out.println("vehiclemanagementsystem.Vehicle registered successfully!");
            System.out.println(vehicle);  // toString() output
        }
    }
    ...
    private static void calculateTaxes() {
        ...
        System.out.println("\n--- Calculating Taxes ---");
        for (Vehicle v : vehicles) {
            System.out.println("vehiclemanagementsystem.Vehicle ID: " + v.getVehicleId() + ", Tax Amount: " + v.calculateTax());
        }
    }
