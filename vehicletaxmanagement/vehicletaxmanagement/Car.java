...
class Car extends Vehicle {
    ...
    public Car(String vehicleId, String ownerName, int yearOfFabrication, String registrationNumber,
               double baseTaxRate, boolean isElectric) {
    ...
    public double calculateTax() {
        ...
        if (java.time.Year.now().getValue() - yearOfFabrication > 10) tax *= 0.9;
        return tax;
    }
